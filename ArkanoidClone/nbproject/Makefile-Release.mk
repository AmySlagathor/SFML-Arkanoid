...
${OBJECTDIR}/Bola.o: Bola.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/SFML -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Bola.o Bola.cpp

${OBJECTDIR}/Ladrillo.o: Ladrillo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/SFML -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Ladrillo.o Ladrillo.cpp
...
${OBJECTDIR}/Rectangulo.o: Rectangulo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/SFML -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Rectangulo.o Rectangulo.cpp

${OBJECTDIR}/arkanoid.o: arkanoid.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/SFML -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/arkanoid.o arkanoid.cpp
